...
public final class CreateReleaseUploadResourceTask extends CreateUploadResourceTask<ReleaseUploadBeginResponse> {

    @Inject
    CreateReleaseUploadResourceTask(@Nonnull TaskListener taskListener, @Nonnull AppCenterServiceFactory factory) {
