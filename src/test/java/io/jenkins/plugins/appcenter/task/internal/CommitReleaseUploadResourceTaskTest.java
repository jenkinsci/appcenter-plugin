...
public class CommitReleaseUploadResourceTaskTest {
    ...
    private CommitReleaseUploadResourceTask task;
    ...
    public void setUp() {
        ...
        task = new CommitReleaseUploadResourceTask(mockTaskListener, factory);
    }
