...
public final class TestUtil {
    ...
    public static TestBuilder createFileForPipeline(final @Nonnull String pathToFile, final @Nonnull String content) {
        return new TestAppWriter(pathToFile, content);
    }
    ...
    private static class TestAppWriter extends TestBuilder {
        ...
        private TestAppWriter(final @Nonnull String pathToFile, @Nonnull String content) {
